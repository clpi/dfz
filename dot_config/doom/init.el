...
(doom! :input
       ...
       (lookup +docsets +offline)              ; navigate your code and its documentation
       (lsp +peek)               ; M-x vscode
       ...
       (python +lsp +pyenv +pyright +conda +poetry)            ; beautiful is better than ugly
       qt                ; thjjje 'cutest' gui framework ever
       ...
       ;;scala             ; java, but good
       (scheme +guile +chicken +mit +chez +chibi)   ; a fully conniving family of lisps
